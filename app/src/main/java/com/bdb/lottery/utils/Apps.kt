...
import com.bdb.lottery.extension.nEmptyEquals
...
object Apps {
    ...
    fun isMainProcess(): Boolean {
        ...
        Timber.d(
            "packageName: ${packageName}, processName: ${processName}, isMainProcess: ${
                processName.nEmptyEquals(
                    packageName
                )
            }"
        )
        return processName.nEmptyEquals(packageName)
    }
    ...
    fun isPlatform(context: Context?, scheme: String): Boolean {
        return scheme.nEmptyEquals(getScheme(context))
    }
