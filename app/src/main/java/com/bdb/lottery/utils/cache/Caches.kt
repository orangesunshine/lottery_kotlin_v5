...
object Caches {
    ...
    fun putDouble(cacheKey: String, cacheValue: Double = 0.0) {
        mmkv?.encode(cacheKey, cacheValue)
    }

    fun getDouble(cacheKey: String, default: Double = 0.0): Double? {
        return mmkv?.decodeDouble(cacheKey, default)
    }
}